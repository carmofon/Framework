...
/**
 * Simulation to evaluate the detachment of a single EPS particle stuck to the
 * substratum
 * 
 * @author Joao Xavier (j.xavier@tnw.tudelft.nl)
 */
public class SingleEPSParticle extends ModelHandler {
	...
	protected static String outputDirectory = "C:/joao/results/singleParticle";
	...
	private static float YEPS_star = 1f; // [gEPS_star/gEPS]

	// diffusivity of solutes
	private static float substrateDiffusivity = 4.2e6f; // [um^2/h]

	// Enzyme parameters
	private static float epsDecayRate = 50f; // [gEPS/gPDP/h]
	...
	protected static float finishIteratinTime = 30f; // [h]
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		float[] fractionalVolumeCompositionH1 = { 0, 0.5f, 0 };
...
//		BiomassParticle b = placeBiomass(_speciesX, 0, systemSize * 0.5f,
//				systemSize * 0.5f);
		int[] inoc = {20};
		inoculateRandomly(inoc);
	}
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new SingleEPSParticle();
