 ...
 */
public class InducedDetachment extends ModelHandler {
	...
	// uncomment
	// inoculation
	protected static int initialParticleNumber = 80;
	...
	protected static float outputEvery = 1000.0f; // [h]
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		// EPS*
		epsStar = new ParticulateSpecies("EPS_star", specificMassEPS, Color.red);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new InducedDetachment();
