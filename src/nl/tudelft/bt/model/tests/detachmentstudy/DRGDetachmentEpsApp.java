 ...
 */
public class DRGDetachmentEpsApp extends ModelHandler {
	//output directory name
	//private final static String outputDirectory =
	// "D:\\results\\drg-detachment-eps\\";
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new DRGDetachmentEpsApp();
		...
		try {
			...
			String dir = outputDirectory + "umax" + df.format(uMax) + "kdet"
					+ df.format(rdetach) + "ki"
					+ df.format(inactivationConstantH) + "\\";
