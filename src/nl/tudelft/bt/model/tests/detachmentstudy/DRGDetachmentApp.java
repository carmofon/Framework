 ...
 */
public class DRGDetachmentApp extends ModelHandler {
	//output directory name
	private final static String outputDirectory = "--D:\\results\\drg-detachment\\";
	// geometry (2D or 3D)
	private static int geometry = 2;
	// Diffusion to reaction:
	private static final float diffusivity = 5.76e6f; //[um2/h]
	private static float uMax = 3.17f; // default val 5.47e-2f
	...
	//
	// detachment
	private static float rdetach = 5.0E-04f;
	/**
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new DRGDetachmentApp();
