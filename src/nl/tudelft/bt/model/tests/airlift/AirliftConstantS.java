 ...
 */
public class AirliftConstantS extends ModelHandler {
	//output directory name
	private static String outputDirectory = "E:/lixo/";
//	private static String outputDirectory = "D:/results/airliftStructure"
//		+ "/constantS/sim13D/";
	// geometry (2D or 3D)
	...
	private static float densityH = 300f; //[gCOD_X/l]
	//
	//Yield coefficients
	...
	private static float relativeMaximumRadius = 0.004f;
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		//		ReactionFactor mHAc = new Monod(carbonSource, KS);
		float mHAc = carbonSourceBulkConcentration
				/ (carbonSourceBulkConcentration + KS);
		ProcessFactor mO = new Saturation(oxygen, KO);
		// create the reactions
		//acetate uptake H1
		Reaction acetateUptakeH1 = new Reaction(
				"acetateUptakeH1", activeH1, qMax * mHAc, 1);
		...
		//acetate
		//		ReactionStoichiometry rsAcetate = new ReactionStoichiometry(1);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new AirliftConstantS();
