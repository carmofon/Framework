 ...
 * @author xavier
 */
public class Kd3minus3_3D extends DetachmentGrowth {
	public static void main(String[] args) {
		System.out.println("running Kd3minus3_3D...");
		// create the application
		Kd3minus3_3D app = new Kd3minus3_3D();
		// set dimensionality to 3D
		DetachmentGrowth.geometry = 3;
		// output
		DetachmentGrowth.outputDirectory = "./Kd3minus3_3D/";
		...
		// visuals off
		app.run(false);
		System.out.println("finished Kd3minus3_3D...");
	}
}