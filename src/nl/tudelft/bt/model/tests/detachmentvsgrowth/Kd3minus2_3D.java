 ...
 * @author xavier
 */
public class Kd3minus2_3D extends DetachmentGrowth {
	public static void main(String[] args) {
		System.out.println("running Kd3minus2_3D...");
		// create the application
		Kd3minus2_3D app = new Kd3minus2_3D();
		// set dimensionality to 3D
		DetachmentGrowth.geometry = 3;
		// output
		DetachmentGrowth.outputDirectory = "./Kd3minus2_3D/";
		...
		DetachmentGrowth.rdetach = 3e-2f; // 300 um 3e-3
		// inoculation
		...
		// visuals off
		app.run(false);
		System.out.println("finished Kd3minus2_3D...");
	}
}