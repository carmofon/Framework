 ...
 * @author xavier
 */
public class Kd1minus3_3D extends DetachmentGrowth {
	public static void main(String[] args) {
		System.out.println("running Kd1minus3_3D...");
		// create the application
		Kd1minus3_3D app = new Kd1minus3_3D();
		// set dimensionality to 3D
		DetachmentGrowth.geometry = 3;
		// output
		DetachmentGrowth.outputDirectory = "results/Kd1minus3_3D/";
		...
		// visuals off
		app.run(false);
		System.out.println("Finished Kd1minus3_3D...");
	}
}