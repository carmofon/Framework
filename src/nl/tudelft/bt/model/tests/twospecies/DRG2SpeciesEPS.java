 ...
 */
public class DRG2SpeciesEPS extends ModelHandler {
	//output directory name
	private final static String outputDirectory = "/Users/jxavier/model/"
			+ "results/2speciesEPS/test/";
	// geometry (2D or 3D)
	...
	public static void main(String[] args) {
		MultigridVariable.setSteps(10, 10);
		ApplicationComponent app = new DRG2SpeciesEPS();
