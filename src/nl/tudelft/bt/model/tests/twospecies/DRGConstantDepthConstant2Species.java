 ...
 */
public class DRGConstantDepthConstant2Species extends ModelHandler {
	//output directory name
	private final static String outputDirectory = "D:\\results\\1Dcomparison"
			+ "\\HeterotrophsNitrifiers\\constant2D\\";
	// geometry (2D or 3D)
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new DRGConstantDepthConstant2Species();
