...
//public class SimplerAngiogenesis_May2016 extends TumorModelHandler {
	public class SimplerAngiogenesis_May2016 extends GranuleModelHandler {
	...
	protected static float oxygenBulkConcentration = 1e-1f; // [g/L]Joao's paper 
	...
	private static float alpha = 5f; // [gX/gS] 1/Oxygen Yield
	private static float delta = 3.5f; // [gX/gS] Angiogenesis cost
...
private static float ko2v = 1e20f;// [g/L] saturation constant on vegf secretion
	...
	protected static float uM4 = uM1 * 1e5f; // [1/h] max oxygen perfusion rate
	protected static float uM6 = uM1 * 0.1f; // [1/h] max vegf secretion rate
	private static float lambda = 3f; // Angiogenic factor decay
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		speciesC.setInducibleColor(vegf, uM6*(0.5f*ko2), Color.yellow,
				new Color(0, 0, 1f));
	...
	protected void inoculate() {
		int[] nCells = {initialParticleNumber, 20};
...
//	}
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new SimplerAngiogenesis_May2016();
