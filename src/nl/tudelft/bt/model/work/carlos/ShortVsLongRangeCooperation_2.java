 ...
 */
public class ShortVsLongRangeCooperation_2 extends TumorModelHandler {
	...
	protected static String outputDirectory = "/Users/CarmonaFontaine/Documents/Xlab/Models/Cooperation/Test";
	static int seed = 99;
	static boolean runWithGraphics = (1 == 1);
	...
	// Reaction parameters
	// GROWTH
	protected static float uMax = 100f; // [h-1]
	...
	// gf1 diffusivity
	private static float Dg1 = 100; // [m2/s]
	// gf2 diffusivity
	private static float Dg2 = 0.1f; // [m2/s]
	// G1 & G2
	...
	// SUBSTRATE
	protected static float sBulkConcentration = 0.002f; // [gS/L] DO 20
	...
	protected static float outputEvery = 0.051f; // [h]
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		rsSubstrate.addReaction(GrowthP2, -1 / YS);
	...
	public static void main(String[] args) {
		...
		*/
		...
		ApplicationComponent app = new ShortVsLongRangeCooperation_2();
