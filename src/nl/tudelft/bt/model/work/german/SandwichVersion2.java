 ...
 */
public class SandwichVersion2 extends GranuleModelHandler {
	...
	protected static String outputDirectory = "C:/Javaresults/test22bis/";
	...
	protected static float substrateBulkConcentration = 3f; // [g/L]

	// in the paper Ds = 1.6e-9 m2/s = 5.76e6 um2/h
	private static float substrateDiffusivity = 5e6f; // [um^2/h]
	// 
	//
	// Particulate species (biomass X)
	protected static float specificMassX = 1030f; // [g/L]

	// Yield coefficients
	private static float YXS = 0.7f; // [gX/gS]

	// Processes
	// Growth (biomass production)
	protected static float uMax = 0.05f; // [1/h]
	protected static float uMaxY = 0.05f; // [1/h]
	// protected static float uMax = 0.0547f; //[1/h]

	private static float KS = 1e-5f; // [g/L]
	private static float KSY = 1e-5f; // [g/L]

	private static float kDeathX = 0.001f; // [h-1]
	private static float kDeathY = 0.001f; // [h-1]

	
	// Computation parameters
	protected static float systemSize = 1700; // [um]

	// relativeMaximumRadius defines the maximum radius of the biomass particles
	// in relation to the system size
	// the maximum radius of a particle is rmax =
	// systemSize*relativeMaximumRadius 1700fL=10um x 10um x 10um
	...
	protected static float relativeBoundaryLayer = 0.00005f;
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		// Create the second biomass species
		...
		// Create the second particulate species (solids)
		// Y active mass
		...
		Reaction growthY = new Reaction("growthY", activeY, uMaxY, 1);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new SandwichVersion2();
