...
public class sandwichversion4 extends GranuleModelHandler {
	...
	protected static String outputDirectory = "C:/Javaresults/test1/";
	...
	protected static float OxygenBulkConcentration = 5e-3f; // [g/L] This value is an overestimation (distilled H2O)
	...
	private static float YGluaer = 0.24f; // [gX/gS] 76%
	private static float YGluana = 0.06f; // [gX/gS] 4.2% (76/18fold)
	private static float YLac = 0.06f; // [gX/gS] All the mass of Glu consumed in fermentation (1/0.042)
	...
	private static float kDeathX = 0.01f; // [h-1]
	private static float kDeathY = 0.15f; // [h-1]
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new sandwichversion4();
