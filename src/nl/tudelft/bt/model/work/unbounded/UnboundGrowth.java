package nl.tudelft.bt.model.work.unbounded;
 ...
 */
public class UnboundGrowth extends GranuleModelHandler {
	...
	protected static String outputDirectory = "/Users/wkc/xlab/results/unbounded";
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		BiomassSpecies speciesX = new GranuleBiomassSpecies("speciesX", spX,
		...
		// Create the biomass species
		BiomassSpecies speciesY = new GranuleBiomassSpecies("speciesY", spY,
		...
		Reaction fluxSubstrate = new Flux("fluxSubstrate", substrate, substrateBulkConcentration);
		...
		rsSubstrate.addReaction(fluxSubstrate, externalMassTransferCoefficient);
	...
	protected void inoculate() {
		...
		inoculateRandomlyEverywhere(nCells, 50);
	}
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new UnboundGrowth();
