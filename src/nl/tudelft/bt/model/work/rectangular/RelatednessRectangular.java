 ...
 */
public class RelatednessRectangular extends ModelHandler {
	 ...
	 */
	public RelatednessRectangular(int verticalExpansion) {
		super();
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new RelatednessRectangular(stretchFactor);
