...
public class InducibleBiomassSpecies extends BiomassSpecies {
	...
	public InducibleBiomassSpecies(String name, ParticulateSpecies[] species,
	...
	public BiomassParticle createBiomassParticle() {
		return new InducibleBiomassParticle(this);
	}
}
