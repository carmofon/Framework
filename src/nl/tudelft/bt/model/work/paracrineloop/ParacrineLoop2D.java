 ...
 */
public class ParacrineLoop2D extends GranuleModelHandler {
	...
	protected static String outputDirectory = "/Users/xlabguest/results/v3/test";
	...
	protected static float initialColonyRadius = 200; // [um]
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		BiomassSpecies speciesMacrophage = new BiomassSpecies(
		...
		// 3. Create the biomass species
		BiomassSpecies speciesCancer = new BiomassSpecies("speciesCancer", spC,
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new ParacrineLoop2D();
