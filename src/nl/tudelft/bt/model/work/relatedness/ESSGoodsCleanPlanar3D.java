 ...
 */
public class ESSGoodsCleanPlanar3D extends ModelHandler {
	...
	protected static float systemSize = 125f; // [um]
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new ESSGoodsCleanPlanar3D();
		// the biofilm thickness
		BiofilmMaximumThicknessSeries thickness = new BiofilmMaximumThicknessSeries();
		...
		try {
			...
			Model.model().setVerticalCutoffSize(50.0f);
			// start the iteration
