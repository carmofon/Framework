 ...
 */
public class Phobia2 extends ModelHandler {
	...
	protected static String outputDirectory = "/Users/abohn/Science/Projects/MULTIDIM/results/";
	...
	protected static float specificMassPhoto = 170f; // [g/L]
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		float[] fractionalVolumeCompositionH1 = { 1.0f, 0.0f };
		...
		ProcessFactor mS = new Saturation(CO2, KS);
		...
		// growth
		Reaction growth = new Reaction("growth", PhotoMass, uMax, 1);
		growth.addFactor(mS);
	...
	public static void main(String[] args) {
		...
		if (args.length >= 2) {
			initialParticleNumber = Integer.parseInt(args[0]);
			graphicsOn = (Integer.parseInt(args[1]) == 1) ;
		}
		MultigridVariable.setSteps(5, 50);
		// create a hande for the application, which will be decorated
		ApplicationComponent app = new Phobia2();
