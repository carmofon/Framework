 ...
 * @author Will Chang
 */
public class MutatorTwoCellTypesErosion extends GranuleModelHandler {
	...
	protected static int simulationFinishIterationCount = 1000;
	
	// Alternatively, use max tumor radius as end criterium
	protected static float simulationFinishRadius = 180;
	
	// Max time step
	protected static float maximumTimeStep = 1000f; // [h]
...
//	protected static float CSF1BulkConcentration = 1e-6f; // [g/L] produces fingers with 1 cell type
	...
	// EGF
//	protected static float EGFBulkConcentration = 1e-6f; // [g/L]
...
//	protected static float externalMassTransferCoefficient = 1e5f; // [h-1]
	protected static float externalMassTransferCoefficient = 3.6e-3f; // [h-1]
	...
	protected static float motility = 24f; // [um/h]
	...
	protected static float stimulatedRcsf1 = 0.01f;
	
	// CSF-1 production cost (this should be < 0)
	protected static float costCSF1 = -0.01f;
	...
	protected static float mutationRate = 0.1f;
	...
	protected static float systemSize = 4000; // [um]
	...
	protected static int initialTumorCellNumber = 100;
	
	// initial number of macrophages
	protected static int initialMacrophageNumber = 20;
...
//		rsTumorMotile.addReaction(basalProduceCSF1ByMotile, costCSF1);
		...
		NetReaction rsEGF = new NetReaction(5);
		...
		NetReaction rsCSF1 = new NetReaction(4);
...
//		rsCSF1.addReaction(basalProduceCSF1ByMotile, 1);
	...
	protected void inoculate() {
		int[] nCells = { initialTumorCellNumber, 0 };
		inoculateRandomly(nCells);
		int[] nCells2 = { 0, initialMacrophageNumber };
		inoculateRandomlyAtRadius(nCells2, systemSize / 8);
	}
	...
	public static void main(String[] args) {
		...
		if (args.length > 0) {
			...
			costCSF1 = Float.parseFloat(args[4]);
