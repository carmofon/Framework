...
/**
 * 1-cell type model w/ decay
 */
public class Decay extends GranuleModelHandler {
	...
	//protected static float substrateBulkConcentration = 1e-4f; // [g/L] produces smooth tumor
	protected static float substrateBulkConcentration = 1e-20f; // [g/L]
	...
	protected static float kd = 1e-20f; // [1/h]
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		Reaction decayX = new Reaction("decay", activeX, kd, 0);
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new Decay();
