 ...
 * @author Will Chang
 */
public class MutatorTwoCellTypesDecaySignal extends GranuleModelHandler {
	...
	// Signal (S)
	protected static float signalBulkConcentration = 1e-5f;
	...
	protected static float mutationRate = 0.05f;
	
	// Half-saturation constant for oxygen growth
	private static float KO = 3.5e-4f; // [g/L]
	// very low KO to decrease O2 dependence to a minimum
	//private static float KO = 3.5e-8f;
	...
	protected static float rdetach = 1e-8f; // NO DETACHMENT PRESENT IN THIS CASE
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		ParticulateSpecies[] spY = { activeY, activeX };
		float[] fractionalVolumeCompositionY = { 1, 0 };
	...
	public static void main(String[] args) {
		...
		ApplicationComponent app = new MutatorTwoCellTypesDecaySignal();
