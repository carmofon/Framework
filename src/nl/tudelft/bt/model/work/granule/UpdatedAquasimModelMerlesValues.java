 ...
 */
public abstract class UpdatedAquasimModelMerlesValues extends GranuleModelHandler {
	...
	protected static float qSMaxPAO = 0.33f; // [gCOD-S/gCOD-XPAO/h]
	...
	private static float KPAOPO4_PP = 1e-3f; // [gP/L]

	private static float KfPHA_P = 0.33f; // [gCOD-PHA/gCOD-XPAO]

	protected static float kPPPAO = 0.0167f; // [gP/gCOD-PAO/h]
	...
	protected static float kGlyPAO = 0.0388f; // [gCOD-Gly/gCOD-PHB/h] Merle
												// ------>

	private static float YGlyAerobicPAO = 1.11f; // [gCOD-Gly/gCOD-XPAO]
	...
	private static float etaNO3 = 0.2f; // Merle

	private static float etaNO2 = 0.2f; // Merle
	...
	protected void defineSpeciesAndReactions() throws ModelException {
		...
		ProcessFactor mHNO3 = new Saturation(nitrate, K_XH_O2);
		// for PAO
