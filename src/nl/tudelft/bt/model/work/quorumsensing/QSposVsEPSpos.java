 ...
 */
public class QSposVsEPSpos extends ModelHandler {
	...
	protected static float initialBiomassQSpos = (1 - f_QSpos)
			/ (1 - f_QSpos + f_QSpos * (specificMassX / specificMassEPS));

	protected static float initialBiomassQSneg = (1 - f_QSneg)
			/ (1 - f_QSneg + f_QSneg * (specificMassX / specificMassEPS));
	...
	protected void inoculate() {
		int[] nCells = { initialParticleNumber_QSpos,
				initialParticleNumber_QSneg };
	...
	public static void run() {
		...
		ApplicationComponent app = new QSposVsEPSpos();
