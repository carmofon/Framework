 ...
 */
public class PublicGoodCooperation_4_CareyModel extends ModelHandler {
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		ProcessFactor mO = new Monod_plus_Good(nutrient,PG, Kn, kpg);
		...
		// active mass
		NetReaction rsXactiveX = new NetReaction(2);
	...
	public static void main(String[] args) throws IOException {
		...
		* (relativeMaximumRadius * systemSize) * systemSize / gridSide * specificMassX;
		...
		ApplicationComponent app = new PublicGoodCooperation_4_CareyModel();
