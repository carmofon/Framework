 ...
 */
public class Example11CMultiProducersToxinDiversity extends ModelHandler {
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		Reaction [] toxinKillingProducers = new Reaction[numberofCellGroups];
		SoluteSpecies[] ToxinArrayKillerProducer= new SoluteSpecies [numberofCellGroups];
		for (int victim = 0; victim < numberofCellGroups; victim++) {
			toxinKillingProducers[victim] = new Reaction(
					"ToxinKillingOf" + victim,
					activeX[victim], kT, 1);
			for (int killer = 0; killer < numberofCellGroups; killer++) {
				if (killer != victim) {
	...
	public static void main(String[] args) throws IOException {
		...
		ApplicationComponent app = new Example11CMultiProducersToxinDiversity();
