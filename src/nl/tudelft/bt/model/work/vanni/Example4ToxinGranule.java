 ...
 */
public class Example4ToxinGranule extends GranuleModelHandler {
	...
	private static float ToxinDiffusivity; //8.33e6f; // [um^2/h]
	...
	protected static float qsMax = 2.00f; // [1/h]
	// protected static float uMax = 0.0547f; //[1/h]

	// Toxin production
	protected static float qT = 0.04f; // [1/h]
	...
	protected static float systemSize = 500f; // [um]
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		BiomassSpecies ToxinMinus = new BiomassSpecies("ToxinMinus", spX,
				fractionalVolumeCompositionH1);
		ToxinMinus.setActiveMass(activeX);

		// 3.1 V.B. Create the second biomass specie
		BiomassSpecies ToxinPlus = new BiomassSpecies("ToxinPlus", spX2,
	...
	public static void main(String[] args) throws IOException {
		...
		ApplicationComponent app = new Example4ToxinGranule();
		...
		ToxinDiffusivity = Float.parseFloat(args[3]);
		...
		* (relativeMaximumRadius * systemSize) * systemSize / gridSide * specificMassX;
		...
		try {
			...
			Model.model().setMaxRunLength(150);
