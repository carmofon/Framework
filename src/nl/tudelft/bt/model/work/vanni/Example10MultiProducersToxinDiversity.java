 ...
 */
public class Example10MultiProducersToxinDiversity extends ModelHandler {
	...
	protected static int numberofCellGroups = 12;
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		for (int i = 0; i < numberofCellGroups; i++) {
			toxinKilling[i] = new Reaction("ToxinKillingOf"+i, activeX[i], kT, numberofCellGroups-1);
			for (int j = 0; j < numberofCellGroups-1; j++) {
				if (i!=j)
		...
		rsXactive[numberofCellGroups-1].addReaction(growth[numberofCellGroups-1], Y);
		rsXactive[numberofCellGroups-1].addReaction(toxinKilling[numberofCellGroups-1], -1);
		rsXactive[numberofCellGroups-1].addReaction(BiomassDecay[numberofCellGroups-1], -1);
		activeX[numberofCellGroups-1].setProcesses(rsXactive[numberofCellGroups-1]);
	...
	public static void main(String[] args) throws IOException {
		...
		ApplicationComponent app = new Example10MultiProducersToxinDiversity();
