 ...
 */
public class PublicGoodCooperation2 extends ModelHandler {
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		// growth for Chaters
		Reaction growthCheaters = new Reaction("growth", activeX, qsMax, 1);
		...
		Reaction growthProducers = new Reaction("growthX2", activeX2, qsMax, 1);
		growthProducers.addFactor(mO);

		// PG production from producers
		Reaction PGProduction = new Reaction("PGProduction", activeX2,
				PGInvestment, 1);

		// PG growth stimulation
		Reaction PGsensingCheater = new Reaction("PGsensingCheater", activeX, kpg, 1);
		ProcessFactor T1 = new Linear1(PG);
		PGsensingCheater.addFactor(T1);
		
		Reaction PGsensingProducer = new Reaction("PGsensingProducer", activeX2, kpg, 1);
		...
		activeX.setProcesses(rsXactiveX);
	...
	public static void main(String[] args) throws IOException {
		...
		* (relativeMaximumRadius * systemSize) * systemSize / gridSide * specificMassX;
		...
		ApplicationComponent app = new PublicGoodCooperation2();
