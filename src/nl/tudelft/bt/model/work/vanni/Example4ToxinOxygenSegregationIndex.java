 ...
 */
public class Example4ToxinOxygenSegregationIndex extends ModelHandler {
	...
	private static BacteriocinBiomassSpecies ToxinMinus;
	private static BacteriocinBiomassSpecies ToxinPlus;
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		ToxinMinus = new BacteriocinBiomassSpecies("ToxinMinus", spX,
				...
				Toxin_Investment, mO, Color.blue, Color.green);
		ToxinMinus.setActiveMass(activeX);

		// 3.1 V.B. Create the second biomass specie
		ToxinPlus = new BacteriocinBiomassSpecies("ToxinPlus", spX2,
	...
	public static void main(String[] args) throws IOException {
		...
		* (relativeMaximumRadius * systemSize) * systemSize / gridSide * specificMassX;
		...
		ApplicationComponent app = new Example4ToxinOxygenSegregationIndex();
		...
		try {
			...
			spw.addSeries(new SegregationIndex(ToxinMinus, ToxinPlus, Lbac));
