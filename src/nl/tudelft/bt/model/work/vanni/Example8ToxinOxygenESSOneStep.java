 ...
 */
public class Example8ToxinOxygenESSOneStep extends ModelHandler {
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		Producer1 = new BiomassSpecies("Producer1", spX,
				fractionalVolumeCompositionH1);
		Producer1.setActiveMass(activeX);

		// 3.1 V.B. Create the second biomass specie
		Producer2 = new BiomassSpecies("Producer2", spX2,
				fractionalVolumeCompositionH2);
		Producer2.setActiveMass(activeX2);
		...
		if (nutrientOff)
			ToxinProduction1 = new Reaction("ToxinProduction1", activeX,
					Toxin_Investment1, 1);
		else {
				ToxinProduction1 = new Reaction("ToxinProduction1", activeX,
				Toxin_Investment1, 1);
		...
		if (nutrientOff)
			ToxinProduction2 = new Reaction("ToxinProduction2", activeX2,
					Toxin_Investment2, 1);
		else {
				ToxinProduction2 = new Reaction("ToxinProduction2", activeX2,
				Toxin_Investment2, 1);
		...
		Reaction ToxinKilling1 = new Reaction("ToxinKilling1", activeX, kT, 1);
	...
	public static void main(String[] args) throws IOException {
		...
		ApplicationComponent app = new Example8ToxinOxygenESSOneStep();
		...
		try {
			...
			Model.model().setCompulsoryTimeStep(0.1f);
