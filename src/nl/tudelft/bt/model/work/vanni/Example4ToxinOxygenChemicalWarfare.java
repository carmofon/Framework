 ...
 */
public class Example4ToxinOxygenChemicalWarfare extends ModelHandler {
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		// 2.1 V.B. Create the particulate species (solids)
		// X2 active mass
		...
		ParticulateSpecies[] spX = { activeX, activeX2 };
		...
		speciesX = new MutatorBiomassSpecies("mutator",
				spX, fractionalVolumeCompositionH2,
				mutationRate, 10);
		speciesX.setActiveMass(activeX);
		speciesX.setActiveMass(activeX2);
		...
		Reaction ToxinProduction2 = new Reaction("ToxinProduction2", activeX,
				Toxin_Investment-0.1f*Toxin_Investment, 1);
	...
	protected void inoculate() {
		...
		int[] nCells = { (int) (InitialRatio*initialParticleNumber) };
	...
	public static void main(String[] args) throws IOException {
		...
		* (relativeMaximumRadius * systemSize) * systemSize / gridSide * specificMassX;
		...
		ApplicationComponent app = new Example4ToxinOxygenChemicalWarfare();
