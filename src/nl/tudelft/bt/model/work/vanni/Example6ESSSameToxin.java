 ...
 */
public class Example6ESSSameToxin extends ModelHandler {
	...
	private void defineSpeciesAndReactions() throws ModelException {
		...
		speciesX = new MutatorBiomassSpecies("mutator",
				...
				mutationRate, numberOfToxinLevels);
		...
		for (int i = 0; i < numberOfToxinLevels; i++) {
			...
			toxinKilling[i] = new Reaction("ToxinKillingOf"+i, activeX[i], kT*(1-f), 1);
			toxinKilling[i].addFactor(new Linear1(Toxin));
		}
		...
		for (int i = 0; i < numberOfToxinLevels; i++) {     
		rsToxin.addReaction(toxinProduction[i], alpha);
		}
	...
	public static void main(String[] args) throws IOException {
		...
		* (relativeMaximumRadius * systemSize) * systemSize / gridSide * specificMassX;
		...
		ApplicationComponent app = new Example6ESSSameToxin();
