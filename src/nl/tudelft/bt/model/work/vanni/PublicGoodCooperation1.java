 ...
 */
public class PublicGoodCooperation1 extends ModelHandler {
	...
	protected static float nutrientBulkConcentration = 8e-8f; // [g/L]
	// in the paper Ds = 1.6e-9 m2/s = 5.76e6 um2/h
	private static float nutrientDiffusivity = 8.33e6f; // [um^2/h]
	...
	protected static float relativeBoundaryLayer = 0.1f / systemSize;
	...
	public static void main(String[] args) throws IOException {
		...
		* (relativeMaximumRadius * systemSize) * systemSize / gridSide * specificMassX;
		...
		ApplicationComponent app = new PublicGoodCooperation1();
